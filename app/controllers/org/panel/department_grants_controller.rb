class Org::Panel::DepartmentGrantsController < Org::Panel::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @department_grant.save
        format.html.phone
        format.html { redirect_to panel_department_grants_url }
        format.js { redirect_back fallback_location: panel_organ_handles_url }
  ...
  def destroy
    ...
    redirect_to panel_organ_handles_url
  end
