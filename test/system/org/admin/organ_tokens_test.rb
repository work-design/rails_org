...
class OrganTokensTest < ApplicationSystemTestCase
  ...
  test "visiting the index" do
    visit org_admin_organ_tokens_url
  ...
  test "creating a Organ token" do
    ...
    fill_in "Expired at", with: @org_admin_organ_token.expired_at
    fill_in "Member", with: @org_admin_organ_token.member
    fill_in "Token", with: @org_admin_organ_token.token
    fill_in "User", with: @org_admin_organ_token.user
