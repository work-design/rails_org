...
class OrgConfigsTest < ApplicationSystemTestCase
  setup do
    @org_admin_org_config = org_admin_org_configs(:one)
  end

  test "visiting the index" do
    visit org_admin_org_configs_url
  ...
  test "creating a Org config" do
    ...
    fill_in "Description", with: @org_admin_org_config.description
    fill_in "Job title", with: @org_admin_org_config.job_title_id
    fill_in "Name", with: @org_admin_org_config.name
    fill_in "Record class", with: @org_admin_org_config.record_class
    fill_in "Record column", with: @org_admin_org_config.record_column
