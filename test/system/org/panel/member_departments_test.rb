...
class MemberDepartmentsTest < ApplicationSystemTestCase
  setup do
    @org_admin_member_department = org_admin_member_departments(:one)
  end

  test "visiting the index" do
    visit org_admin_member_departments_url
  ...
  test "creating a Member department" do
    ...
    fill_in "Job title", with: @org_admin_member_department.job_title_id
    fill_in "Office", with: @org_admin_member_department.office_id
