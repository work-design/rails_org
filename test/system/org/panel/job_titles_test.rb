...
class JobTitlesTest < ApplicationSystemTestCase
  setup do
    @org_admin_job_title = org_admin_job_titles(:one)
  end

  test "visiting the index" do
    visit org_admin_job_titles_url
  ...
  test "creating a Job title" do
    ...
    fill_in "Department", with: @org_admin_job_title.department
    fill_in "Grade", with: @org_admin_job_title.grade
    fill_in "Name", with: @org_admin_job_title.name
