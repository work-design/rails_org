...
class DepartmentGrantsTest < ApplicationSystemTestCase
  setup do
    @org_admin_department_grant = org_admin_department_grants(:one)
  end

  test "visiting the index" do
    visit org_admin_department_grants_url
  ...
  test "creating a Department grant" do
    ...
    fill_in "Department", with: @org_admin_department_grant.department_id
    fill_in "Job title", with: @org_admin_department_grant.job_title_id
    fill_in "Organ handle", with: @org_admin_department_grant.organ_handle_id
